...
static const struct SpriteFrameImage sPicTable_Tadhg[] = {
    overworld_frame(gObjectEventPic_Tadhg, 2, 4, 0),
    overworld_frame(gObjectEventPic_Tadhg, 2, 4, 1),
    overworld_frame(gObjectEventPic_Tadhg, 2, 4, 2),
    overworld_frame(gObjectEventPic_Tadhg, 2, 4, 0),
    overworld_frame(gObjectEventPic_Tadhg, 2, 4, 0),
    overworld_frame(gObjectEventPic_Tadhg, 2, 4, 1),
    overworld_frame(gObjectEventPic_Tadhg, 2, 4, 1),
